...
function exibirTextoNaTela(tag, texto) {
    ...
    responsiveVoice.speak(texto, "Brazilian Portuguese Female", {rate:1.2}); //Acionar a linha 7 do HTML, informar para falar. Nos parametros estou ligando a uma variavel com texto, idioma e genero de voz, por fim a velocidade da fala
}
...
//NO TOPICO 03 DA AULA 05, MOSTRA COMO FAZER UM DEPLOY PARA AS PESSOAS USAREM A APLICAÇÃO